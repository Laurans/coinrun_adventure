...
class ConfigSingle(object):
    ...
    def __init__(self):
        ...
        type_keys.append(("ent", "entropy_coeff", float, 0.01))
    ...
    def get_test_frac(self):
        return 0.5 if self.TEST else 0
    ...
    def get_load_filename(self, base_name=None, restore_id=None):
        ...
        filename = Config.get_save_file_for_rank(
            0, self.process_field(restore_id), base_name=base_name
        )
